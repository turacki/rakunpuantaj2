          ...
          <div className="flex items-center gap-4 mb-2">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-1">
                <p className="text-[10px] font-black text-indigo-500 uppercase tracking-widest">Puantaj Pro</p>
                <button 
                  onClick={loadData}
                  disabled={loading}
                  className={`p-1 rounded-md transition-all ${loading ? 'text-slate-300' : 'text-slate-400 hover:text-indigo-600'}`}
