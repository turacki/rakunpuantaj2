          ...
          <div className="bg-white rounded-[3rem] shadow-2xl w-full max-w-lg p-10">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <input type="date" className="px-6 py-4 bg-slate-50 rounded-2xl font-bold outline-none" value={tForm.date} onChange={e => setTForm({...tForm, date: e.target.value})} />
                <input type="date" placeholder="Vade (Opsiyonel)" className="px-6 py-4 bg-slate-50 rounded-2xl font-bold outline-none border-2 border-dashed border-red-100" value={tForm.dueDate || ''} onChange={e => setTForm({...tForm, dueDate: e.target.value})} />
              </div>
