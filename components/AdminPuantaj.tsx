...
import { Coffee, Banknote, ShoppingBag, Trash2, Calendar, Edit2, X, Check, HandCoins, RefreshCw, ClipboardList, AlertTriangle, Check as CheckIcon, AlertCircle, Settings2, Send, CheckCircle2, Plus, Search, Save, UserPlus } from 'lucide-react';
