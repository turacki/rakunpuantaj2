    ...
    try {
      ...
      reader.onload = async (event) => {
        try {
          ...
          await db.importAllData(snapshot);
          alert("Veriler başarıyla içe aktarıldı!");
          loadData();
        } catch (err: any) { alert("Geçersiz dosya formatı: " + err.message); }
      };
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-4 mt-1">
              ...
              <label className="flex items-center gap-1.5 text-[9px] font-black uppercase tracking-widest text-emerald-500 hover:text-emerald-700 cursor-pointer">
